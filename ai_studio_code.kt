...
class MainActivity : AppCompatActivity() {
    ...
    // Demande de permission CAMERA moderne AndroidX
    ...
    // Écouteur en temps réel pour synchroniser l'état avec le système
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 2. Initialisation du CameraManager et recherche de la caméra arrière avec flash
        ...
        // 4. Clic sur le bouton unique au centre
    ...
    override fun onStop() {
        super.onStop()
        // Éteindre le flash si l'application passe en arrière-plan
